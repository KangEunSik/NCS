...
<div class="main">
		...
		$(document).ready(function() {
			...
			$(".btn").on("click", function() {
				...
				if (btitle != "" && bcontent != "") {
					...
					fObject.attr("action", "/controller/boardQna/write");
					fObject.submit();
				} else {
					swal({
						title : "경고!",
	...
	<form class="form" method="post" action="/controller/boardQna/write"
		...
		<table id="content">
			...
			<tr>
				<td colspan=2 id="bcontent" style="height: 300px; vertical-align: top; text-align: left;">
				<textarea id="bcontent2"  maxlength="100" rows=10 name="bcontent"></textarea></td>
			</tr>
			<tr>
				<th>첨부파일</th>
